...
public class User_Location_DataModel {
    ...
    public String toString() {
        return "User_Location_DataModel{" +
    ...
    public User_Location_DataModel() {
    }

    public User_Location_DataModel(String PROPERTY_TYPE,
                                   String RENT_PER_MONTH, String HOUSE_NUMBER,
                                   String HOUSE_OWNER_PHONE_NUMBER, String HOUSE_OWNER_NAME,
                                   GeoPoint EXACT_LOCATION, String BED_ROOMS, String BATHROOMS) {
        this.PROPERTY_TYPE = PROPERTY_TYPE;
        this.RENT_PER_MONTH = RENT_PER_MONTH;
        this.HOUSE_NUMBER = HOUSE_NUMBER;
        this.HOUSE_OWNER_PHONE_NUMBER = HOUSE_OWNER_PHONE_NUMBER;
