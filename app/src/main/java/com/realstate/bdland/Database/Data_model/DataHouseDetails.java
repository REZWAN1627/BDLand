...
public class DataHouseDetails {
    ...
    public DataHouseDetails() {
    }

    public DataHouseDetails(String BALCONY, String BATHROOMS, String BED_ROOMS, String IMAGE_URL,
                            String KITCHEN, String PROPERTY_TYPE, String RENT_PER_MONTH, String HOUSE_NUMBER,
                            String LOCATION, String SECTOR_LOCATION, String FLAT_DESCRIPTION) {
        this.BALCONY = BALCONY;
        this.BATHROOMS = BATHROOMS;
        this.BED_ROOMS = BED_ROOMS;
        this.IMAGE_URL = IMAGE_URL;
